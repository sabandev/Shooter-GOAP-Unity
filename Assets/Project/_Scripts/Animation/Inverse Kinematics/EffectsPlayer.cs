...
namespace HoaxGames
{
    ...
    public class EffectsPlayer : MonoBehaviour
    {
        ...
        public class EffectsAudio : EffectsBase
        {
            ...
            [SerializeField] protected AudioMixerGroup m_optionalAudioMixerGroup;
            ...
            public override void init(string name, Transform parent)
            {
                ...
                m_audioSource.outputAudioMixerGroup = m_optionalAudioMixerGroup;
            }
        ...
        public virtual void play(GroundedResult result)
        {
            IKResult ikRes = new IKResult(result.groundedPosition, result.groundedPosition, true, result.groundedPosition, result.groundedPosition, result.groundedNormal, result.groundedTransform, result.groundedTransform);
            play(ikRes);
        }
