...
namespace HoaxGames
{
    ...
    public class FootIK : MonoBehaviour
    {
        ...
        protected GroundedResultEvent m_onGroundedExited; public GroundedResultEvent onGroundedExited { get { return m_onGroundedExited; } }
        ...
        protected GroundedResult m_lastPotentiallyValidGroundedResult = new GroundedResult(false, false, null, Vector3.zero, Vector3.zero, Vector3.zero);
        ...
        protected virtual void OnAnimatorIK(int layerIdx)
        {
            ...
            else
            {
                if (m_isGrounded)
                {
                    if (m_onGroundedExited != null) m_onGroundedExited.Invoke(m_lastPotentiallyValidGroundedResult);
                    m_isGrounded = false;
                    m_lastPotentiallyValidGroundedResult.init(false, false, null, Vector3.zero, Vector3.zero, Vector3.zero);
                }
